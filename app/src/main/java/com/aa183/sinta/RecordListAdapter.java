...
public class RecordListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.txtName.setText(model.getNegara());
        holder.txtGenre.setText(model.getPresiden());
        holder.txtDurasi.setText(model.getBenua());
        holder.txtSutradara.setText(model.getPopulasi());
        return row;
